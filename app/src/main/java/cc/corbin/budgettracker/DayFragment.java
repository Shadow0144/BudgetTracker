...
public class DayFragment extends Fragment
{
    ...
    public void updateExpenditure(int index, ExpenditureEntity exp)
    {
        final LinearLayout itemsContainer = getActivity().findViewById(R.id.itemsContainer);
        final ExpenditureItem view = ((ExpenditureItem) (itemsContainer.findViewById(index)));
        view.updateExpenditure(exp);
        _expenditureEntities.get(index).update(exp);
        _viewModel.updateExpEntity(_entities, exp);
    }

    public void deleteExpenditure(int index, ExpenditureEntity exp)
    {
        final LinearLayout itemsContainer = getActivity().findViewById(R.id.itemsContainer);
        final ExpenditureItem view = ((ExpenditureItem) (itemsContainer.findViewById(index)));
    ...
    {
        final LinearLayout itemsContainer = getActivity().findViewById(R.id.itemsContainer);
        final int childCount = itemsContainer.getChildCount();
        for (int i = 0; i < childCount; i++)
        {
            itemsContainer.getChildAt(i).setId(i);
        }
    }
